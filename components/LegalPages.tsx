    ...
    const renderTerms = () => (
        <div className="space-y-8 text-sm text-zinc-700 dark:text-zinc-300 leading-relaxed text-justify pb-12">
            <div>
                ...
                <div className="mt-4 p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-900/50 rounded-lg text-xs text-red-800 dark:text-red-300 font-bold">
                    ВНИМАНИЕ: Оплата сервиса означает ваше полное и безоговорочное согласие с тем, что лицензия не подлежит возврату, а сервис предоставляется на условиях «КАК ЕСТЬ» без каких-либо гарантий.
                </div>
            </div>
            
            <section>
                <h3 className="text-lg font-bold text-zinc-900 dark:text-white mb-3">1. Общие положения и Права на изменение</h3>
                ...
                <p>1.3. Сервис предоставляется на условиях «как есть» (AS IS). Лицензиар не гарантирует, что ПО будет соответствовать ожиданиям Пользователя, работать бесперебойно, быстро или без ошибок.</p>
                <div className="bg-zinc-100 dark:bg-zinc-800 p-3 rounded mt-2 border-l-4 border-indigo-500">
                    <p className="font-bold text-zinc-900 dark:text-white">1.4. Изменение условий в одностороннем порядке</p>
                    <p className="mt-1 text-xs">Лицензиар имеет безусловное право в любой момент изменять условия настоящей Оферты, Тарифы и функциональность Сервиса без предварительного уведомления Пользователя. Изменения вступают в силу с момента их публикации на сайте. Продолжение использования Сервиса после публикации изменений означает автоматическое согласие Пользователя с новыми условиями.</p>
                </div>
            </section>
            ...
            <section>
                ...
                <p>2.2. Территория использования: весь мир. Срок использования: определяется сроком действия оплаченной подписки или бессрочно (для тарифов Lifetime), но не долее срока существования самого Сервиса.</p>
                <p>2.3. Пользователю запрещается: декомпилировать код, создавать копии ПО, передавать данные учетной записи третьим лицам, использовать ПО для нарушения законодательства.</p>
            </section>
            ...
            <section className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-5 rounded-xl">
                ...
                <p>3.1. Стоимость лицензии определяется Тарифами, опубликованными на сайте. Лицензиар имеет право изменять тарифы в одностороннем порядке.</p>
            ...
            <section className="bg-red-50 dark:bg-red-900/10 p-5 rounded-xl border border-red-100 dark:border-red-900/30 mt-6">
                <h3 className="text-lg font-bold text-red-700 dark:text-red-400 mb-3">5. ПОЛНЫЙ ОТКАЗ ОТ ВОЗВРАТА СРЕДСТВ (NO REFUND POLICY)</h3>
                <p>5.1. Предметом договора является предоставление права использования ПО (лицензия). Услуга считается оказанной в полном объеме в момент предоставления доступа (активации статуса в Личном кабинете), независимо от того, воспользовался ли Пользователь функционалом фактически.</p>
                <p className="mt-2">5.2. В соответствии с законодательством РФ (и международной практикой продажи цифровых товаров), лицензионные договоры на ПО не подлежат расторжению с возвратом средств за неиспользованный период.</p>
                <p className="mt-2 font-bold">5.3. Пользователь осознает и принимает, что оплата тарифов "Lifetime" (Навсегда) или годовых подписок не подлежит возврату ни при каких обстоятельствах, включая случаи прекращения работы Сервиса по инициативе Лицензиара.</p>
            </section>
            ...
            <section>
                ...
                <ul className="list-disc pl-5 space-y-1 mt-2 text-zinc-600 dark:text-zinc-400">
                    ...
                    <li>Сбои в работе сервисов третьих лиц (Vercel, Clerk, Google, ЮKassa).</li>
                    <li>Ошибки в работе ПО, потерю пользовательского контента.</li>
                </ul>
                <p className="mt-2 font-bold">6.2. Максимальная совокупная ответственность Лицензиара по любым искам ограничивается суммой 100 (сто) рублей, либо суммой последнего платежа Пользователя (на выбор Лицензиара).</p>
                <p className="mt-2 font-bold text-red-500">6.3. Лицензиар имеет право в любой момент прекратить поддержку и работу Сервиса полностью или частично (Shut down) без выплаты каких-либо компенсаций или возвратов Пользователям.</p>
            </section>
            ...
            <section>
                ...
                <p>8.1. Ко всем отношениям по настоящему Договору применяется право Российской Федерации. Пользователь отказывается от участия в любых групповых исках (Class Action Waiver) против Лицензиара.</p>
                ...
                <p>8.3. В случае недостижения согласия споры подлежат рассмотрению исключительно в суде по месту нахождения Лицензиара (договорная подсудность).</p>
            </section>
            ...
            <section>
                ...
                <p>10.2. Лицензиар вправе в одностороннем порядке заблокировать аккаунт Пользователя без возврата средств в случае нарушения условий настоящего Договора (включая спам, попытки взлома, нарушение авторских прав) или без объяснения причин.</p>
            </section>
