...
export const LegalPage: React.FC<LegalPageProps> = ({ type }) => {
    ...
    const renderTerms = () => (
        <div className="space-y-8 text-sm text-zinc-700 dark:text-zinc-300 leading-relaxed text-justify pb-12">
            ...
            <section>
                <h3 className="text-lg font-bold text-zinc-900 dark:text-white mb-3">8. Срок действия и Расторжение</h3>
                <p>8.1. Договор вступает в силу с момента Акцепта и действует до момента удаления аккаунта Пользователем или Лицензиаром.</p>
                <p>8.2. Лицензиар вправе в одностороннем порядке заблокировать аккаунт Пользователя без возврата средств в случае нарушения условий настоящего Договора (включая спам, попытки взлома, нарушение авторских прав).</p>
            </section>
