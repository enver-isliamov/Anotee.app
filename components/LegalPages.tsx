    ...
    const renderTerms = () => (
        <div className="space-y-8 text-sm text-zinc-700 dark:text-zinc-300 leading-relaxed text-justify pb-12">
            ...
            <section>
                ...
                <p className="font-bold text-zinc-900 dark:text-white mt-2">1.4. Изменение условий: Лицензиар имеет право в любой момент в одностороннем порядке изменять условия настоящей Оферты, Тарифы и функциональность Сервиса без предварительного уведомления Пользователя. Изменения вступают в силу с момента их публикации на сайте. Продолжение использования Сервиса после публикации изменений означает согласие Пользователя с новыми условиями.</p>
            </section>
            ...
            <section className="bg-red-50 dark:bg-red-900/10 p-5 rounded-xl border border-red-100 dark:border-red-900/30 mt-6">
                ...
                <p className="mt-2">5.3. Пользователь осознает и принимает, что оплата тарифов "Lifetime" (Навсегда) или годовых подписок не подлежит возврату ни при каких обстоятельствах, включая случаи прекращения работы Сервиса.</p>
            </section>
            ...
            <section>
                ...
                <p className="mt-2 font-bold">6.3. Лицензиар имеет право в любой момент прекратить поддержку и работу Сервиса полностью или частично без выплаты каких-либо компенсаций Пользователям.</p>
            </section>
