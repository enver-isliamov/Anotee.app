            ...
            <div className="bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6">
                <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                        <h3 className="font-bold text-zinc-900 dark:text-white mb-1">Data Optimization & Legacy Claim</h3>
                        <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-4">
                            Run this tool to claim ownership of projects created under your email before the Auth upgrade, and optimize database indexing.
                        </p>
