...
| ISS-010 | P2 | 33 × alert/confirm вместо тостов | AdminTabs 12, Profile 13, Roadmap 3, Dashboard/Player/ProjectView 5 (confirm) | 🟡 open | Требуется прокинуть notify в Admin/Profile (нет пропа); ~3 ч. confirm оставить нативным (нужен выбор) |
