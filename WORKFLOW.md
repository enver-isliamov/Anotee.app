...
4.  **Версионирование (App Version)**:
    *   Динамическое обновление номера версии (`vX.X.X`) на главной странице и в логах через админку.
    *   Позволяет помечать обновления без пересборки фронтенда.
