...
const DICTIONARIES: Record<Language, Record<string, string>> = {
  ...
  ru: {
    ...
    'pv.manage_team': 'Управление командой',
    'pv.share_public': 'Публичная ссылка',
    'pv.org_settings': 'Настройки Организации',
    'pv.storage.drive': 'Google Диск',
    'pv.storage.local': 'Локальный режим',
    'pv.storage.cloud': 'Облако SmoTree',
    'pv.drop.title': 'Перетащите видео сюда',
    'pv.drop.desc': 'Файл будет загружен в',
    'pv.del_modal.title': 'Удалить файл?',
    'pv.del_modal.desc': 'Вы собираетесь удалить',
    'pv.del_modal.everywhere': 'Удалить везде',
    'pv.del_modal.everywhere_desc': 'Удалить из дашборда и корзины Drive',
    'pv.del_modal.dash': 'Удалить из дашборда',
    'pv.del_modal.dash_desc': 'Файлы останутся в хранилище',
